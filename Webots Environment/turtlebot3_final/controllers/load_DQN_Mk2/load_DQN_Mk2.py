...
#model_path = 'F:/Webots/SIX_MODELS/validation models/DQN2_13000000.zip' # alternative model
model_path = 'F:/Webots/SIX_MODELS/validation models/DQN2_14200000.zip' # alternative model
...
for e in range(episodes):
    # swap out for different setup S2, ..., S7
    filename = 'DQN2.S2.SIM.' + str(int(time.time())) + '.txt'
