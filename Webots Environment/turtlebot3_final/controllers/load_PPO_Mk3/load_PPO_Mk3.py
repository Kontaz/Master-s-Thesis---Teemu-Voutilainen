...
#model_path = 'F:/Webots/SIX_MODELS/validation models/PPO3_1900000.zip' # alternative model
#model_path = 'F:/Webots/SIX_MODELS/validation models/PPO3_6000000.zip' # alternative model
model_path = 'F:/Webots/SIX_MODELS/validation models/PPO3_11000000.zip' # alternative model
...
for e in range(episodes):
    ...
    filename = 'PPO3.S5.SIM.' + str(int(time.time())) + '.txt'
