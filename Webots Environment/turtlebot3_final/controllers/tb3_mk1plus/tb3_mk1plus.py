...
class Turtlebot3_RL(Supervisor, gym.Env):
    def __init__(self, max_episode_steps=1000):
        ...
        self.action_space = gym.spaces.Discrete(5) # forward, backward, turn right, and turn left. Optionally stop, slow, continue
...
def main():
    ID = "MK1plus_PPO_test1"
    t = int(time.time())
    parent_dir = "F:\Webots\TB3_FINAL_LOGS_AND_MODELS_MK1plus"
